...
**Hello Rails Backend app** is a Ruby-On-Rails built application which aims to develop the backend of a full stack application of the ror and react combination. It creates api for random greeting messages.
...
https://github.com/AliRezaBmeDu/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/AliRezaBmeDu/hello-rails-back-end/issues).
